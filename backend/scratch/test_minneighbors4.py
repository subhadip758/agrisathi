...
def check_human_or_non_plant_v3(image_path):
    ...
    # 1. Face Cascade Detection (minNeighbors=4, minSize=(30, 30))
    faces = face_cascade.detectMultiScale(gray, scaleFactor=1.08, minNeighbors=4, minSize=(30, 30))
    profiles = profile_cascade.detectMultiScale(gray, scaleFactor=1.08, minNeighbors=4, minSize=(30, 30))
...
print(check_human_or_non_plant_v3(user_screenshot_path))

print("\n--- 2. HUMAN PERSON PHOTO ---")
print(check_human_or_non_plant_v3(human_photo_path))
